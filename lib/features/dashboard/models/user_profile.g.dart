...
void _userProfileSerialize(
  ...
  writer.writeString(offsets[2], object.raptApiKey);
...
UserProfile _userProfileDeserialize(
  ...
  object.raptApiKey = reader.readStringOrNull(offsets[2]);
...
extension UserProfileQueryFilter
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      raptApiKeyContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'raptApiKey',
        value: value,
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      raptApiKeyMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'raptApiKey',
        wildcard: pattern,
...
extension UserProfileQuerySortBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByRaptApiKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'raptApiKey', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByRaptApiKeyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'raptApiKey', Sort.desc);
    });
  }
...
extension UserProfileQuerySortThenBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByRaptApiKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'raptApiKey', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByRaptApiKeyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'raptApiKey', Sort.desc);
    });
  }
...
extension UserProfileQueryWhereDistinct
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByRaptApiKey(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'raptApiKey', caseSensitive: caseSensitive);
    });
  }
...
extension UserProfileQueryProperty
  ...
  QueryBuilder<UserProfile, String?, QQueryOperations> raptApiKeyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'raptApiKey');
    });
  }
